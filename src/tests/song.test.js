...
test("POST -> 'URL_SONGS', should return code 201 and res.body.name === song.name", async () => {
...
test("GET ONE -> 'URL_SONGS/:id', should return code 200 and res.body.name === song.name", async () => {
    const res = await request(app)
...
test("POST -> 'URL_SONGS/id:/artists', should return status code 200 and res.body.length === 1", async () => {
    const artist = {
        name: "LR",
...
test("POST -> 'URL_SONGS/id:/genres', should return status code 200 and res.body.length === 1", async () => {
...
test("DELETE -> 'URL_SONGS/:id', should return code 204", async () => {
    const res = await request(app)
